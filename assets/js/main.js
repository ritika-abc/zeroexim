; (function ($) {
    ...
    $(document).ready(function () {
        ...
        /* -----------------------------------------------------
            Variables
        ----------------------------------------------------- */
        var leftArrow = '<img src="image/icon/left.gif">';
        var rightArrow = '<img class="right-rot" src="image/icon/right.gif">';
        ...
        $('.banner-slider').owlCarousel({
            ...
            items: 1,
            smartSpeed: 1800,
            navText: ['<img src="image/icon/left.gif"/>','<img class="right-rot" src="image/icon/right.gif">'],           
        });
        ...
        $('.team-slider').owlCarousel({
            ...
            loop: true,
            autoplay:true,
            // navText: ['<img src="image/icon/left.gif"/>','<img src="assets/img/icon/right-arrow.png"/>'],           
            responsive : {                
                769 : {
                    items: 3,
                },
